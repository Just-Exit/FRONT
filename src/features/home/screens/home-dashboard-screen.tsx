    ...
    <Screen style={styles.screen}>
      ...
      >
        ...
        <View style={styles.greetingRow}>
          <Text style={styles.greeting}>좋은 아침입니다, 엠총이님.</Text>
        ...
        <View style={styles.tipCard}>
          ...
          <Text style={styles.tipButton}>더 알아보기</Text>
        </View>
        ...
        >
          {recentItems.map((item) => (
            <Pressable
              key={item.id}
              accessibilityRole={
                item.status === 'complete' ? 'button' : undefined
              }
...
const styles = StyleSheet.create({
  ...
  scoreValue: { fontSize: 31, fontWeight: '600', color: colors.textPrimary },
